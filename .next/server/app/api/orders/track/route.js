"use strict";(()=>{var e={};e.id=5433,e.ids=[5433],e.modules={72934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},65694:(e,r,t)=>{t.r(r),t.d(r,{originalPathname:()=>h,patchFetch:()=>x,requestAsyncStorage:()=>d,routeModule:()=>c,serverHooks:()=>m,staticGenerationAsyncStorage:()=>l});var s={};t.r(s),t.d(s,{GET:()=>p});var o=t(73278),a=t(45002),n=t(54877),i=t(71309),u=t(86660);async function p(e){let{searchParams:r}=new URL(e.url),t=r.get("orderNumber")?.trim(),s=r.get("phone")?.trim();if(!t)return i.NextResponse.json({error:"Order reference number is required."},{status:400});let o=(0,u.e)().from("orders").select(`
      id,
      order_number,
      status,
      created_at,
