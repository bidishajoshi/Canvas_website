...
> = {
  ...
  cozy_canvas_collection: (s) => <CozyCanvasCollection key={s.id} section={s} />,
...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      {/* Fallback Cozy Canvas Collection if homepage sections not populated in DB */}
      {!sections.some((s) => s.section_key === 'cozy_canvas_collection') && (
